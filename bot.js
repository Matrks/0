...
client.on("message", (message) => {
   ...
   if (message.content.startsWith("$new")) {     /// ALPHA CODES
        ...
        if (message.guild.channels.exists("name", "ticket-${current}" + message.author.id)) return message.channel.send(`You already have a ticket open.`);    /// ALPHA CODES
        message.guild.createChannel(`ticket-${message.author.username}`, "text").then(c => {
            ...
            message.channel.send(`:white_check_mark: Your ticket has been created, #${current}`);
